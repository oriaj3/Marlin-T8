 ...
 */
//FIXME: REVISAR X_ Y_ Z_ inverrtidos en el marlin anterior y  z_MINPROBE_
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 38, -4, -2.0 }
...
#define X_MIN_POS -38 //FIXME: comprobar con la printer
#define Y_MIN_POS 0
#define Z_MIN_POS 0
