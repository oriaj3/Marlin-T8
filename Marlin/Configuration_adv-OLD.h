/**
 * Marlin 2.0 SKR Anet T8, directo 11/04/2020
 * 
 * 
...
#define LCD_SHOW_E_TOTAL
  ...
  //#define PRINT_PROGRESS_SHOW_DECIMALS // Show progress with decimal digits
    ...
    #define ROTATE_PROGRESS_DISPLAY    //OJO //Display (P)rogress, (E)lapsed, and (R)emaining time
  #endif
#endif

#if HAS_CHARACTER_LCD && EITHER(SDSUPPORT, LCD_SET_PROGRESS_MANUALLY)
  #define LCD_PROGRESS_BAR              //OJO// Show a progress bar on HD44780 LCDs for SD printing
  ...
  //OJO// Si tengo problemas con la detección de la SD poner a low 
 ...
 */
  ...
  #define PROBE_PT_2_Y F60
  #define PROBE_PT_3_X 60
  #define PROBE_PT_3_Y 200
#endif
